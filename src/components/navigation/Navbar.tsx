...
import { Menu, X, CheckSquare, Plus, User, LogOut, ChevronDown, Globe, Code } from 'lucide-react';
import { useAuth } from '../../contexts/AuthContext';
import { useLanguage, getLanguageLabel, Language } from '../../contexts/LanguageContext';
          ...
          <div className="px-2 pt-2 pb-3 space-y-1">
            ...
            <div className="border-t border-gray-200 pt-3 mt-3">
              ...
              <Link
                to="/profile"
                onClick={() => setIsMenuOpen(false)}
                className="flex items-center space-x-3 w-full px-3 py-2 text-base font-medium text-gray-700 hover:text-indigo-600 hover:bg-gray-50 transition-colors"
              >
              ...
              <button
                onClick={handleLogout}
                className="flex items-center space-x-3 w-full px-3 py-2 text-base font-medium text-red-600 hover:bg-red-50 transition-colors"
              >
